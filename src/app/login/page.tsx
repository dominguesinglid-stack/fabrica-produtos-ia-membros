          ...
          <div className="space-y-4">
            <label className="block">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-[#0b1020] px-4">
                ...
                <input className="h-14 w-full bg-transparent outline-none" placeholder="seuemail@email.com" />
              </div>
            </label>
            <label className="block">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-[#0b1020] px-4">
                ...
                <input type="password" className="h-14 w-full bg-transparent outline-none" placeholder="••••••••" />
              </div>
            </label>
            <Link href="/dashboard" className="block">
              <button className="mt-2 h-14 w-full rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-500 font-black text-white">
                Entrar agora
              </button>
            </Link>
            <p className="text-center text-sm text-slate-400">Login real será conectado ao Supabase na próxima etapa.</p>
          </div>
        </section>
      </div>
    </main>
