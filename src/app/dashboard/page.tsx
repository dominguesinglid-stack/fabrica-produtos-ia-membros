...
import { BookOpen, LogOut, Search, Sparkles, Trophy } from "lucide-react";
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="mb-8 grid gap-6 lg:grid-cols-[1.2fr_.8fr]">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.055] p-8 shadow-2xl">
            ...
            <p className="mt-4 max-w-2xl text-lg leading-8 text-slate-300">Comece pelo Módulo 1 e use os prompts para transformar uma ideia em uma oportunidade real.</p>
            <Link href="/modulo/1"><button className="mt-6 rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-500 px-6 py-4 font-black">Continuar Módulo 1</button></Link>
          </div>
