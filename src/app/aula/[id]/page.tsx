    ...
    <main className="min-h-screen bg-[#060914] text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-10">
        ...
        <article className="rounded-[2rem] border border-white/10 bg-white/[0.055] p-8 shadow-2xl">
            <p className="font-black text-violet-300">AULA PREMIUM</p><h1 className="mt-2 text-4xl font-black tracking-tight">{lesson.title}</h1>{lesson.subtitle && <p className="mt-4 text-lg text-slate-300">{lesson.subtitle}</p>}<p className="mt-3 text-slate-400">⏱ {lesson.duration}</p><div className="mt-5"><p className="mb-2 text-sm font-bold text-violet-300">Módulo 1 • Progresso 18%</p><div className="h-3 overflow-hidden rounded-full bg-white/10"><div className="h-full w-[18%] rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-500"></div></div></div>          <div className="mt-8 grid gap-5">
